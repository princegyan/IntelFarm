...
smtp_host = "http://smtp.gmail.com" # This is the host of the SMTP provider
smtp_port = 587 # This is the port that your SMTP provider uses [25]

smtp_sender = "princealfredgyan@gmail.com" # This is the FROM email address
smtp_receivers = ['kamponsah.amponsah@gmail.com'] # This is the TO email address
...
message_dead = """From: Soil Moisture <princealfredgyan@gmail.com>
To: Farmer Effah <kamponsah.amponsah@gmail.com>
...
message_alive = """From: Sender Name <princealfredgyan@gmail.com>
To: Receiver Name <kamponsah.amponsah@gmail.com>
Subject: Moisture Sensor Notification
